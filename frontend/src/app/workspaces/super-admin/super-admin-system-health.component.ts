      ...
      <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 pb-4 border-b border-border">
        <div>
          <div class="flex items-center gap-2">
            ...
            <span class="text-xs text-muted-foreground font-mono">Platform Health & Terminology</span>
          </div>
          <h1 class="text-2xl font-bold tracking-tight text-foreground mt-1">
            System Monitoring & Global Configuration
          </h1>
          <p class="text-xs text-muted-foreground mt-0.5">
            Monitor microservice uptime, PostgreSQL database connection pool, Redis cache health, and standard terminology code systems.
          </p>
        </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="p-4 rounded-xl border border-emerald-500/30 bg-emerald-500/5 shadow-xs">
          <div class="flex items-center justify-between">
            <span class="text-xs font-semibold text-emerald-700 dark:text-emerald-300">Core Services</span>
        ...
        <div class="p-4 rounded-xl border border-blue-500/30 bg-blue-500/5 shadow-xs">
          <div class="flex items-center justify-between">
            <span class="text-xs font-semibold text-blue-700 dark:text-blue-300">PostgreSQL Database</span>
        ...
        <div class="p-4 rounded-xl border border-purple-500/30 bg-purple-500/5 shadow-xs">
          <div class="flex items-center justify-between">
            <span class="text-xs font-semibold text-purple-700 dark:text-purple-300">WORM Audit Engine</span>
        ...
        <div class="p-4 rounded-xl border border-amber-500/30 bg-amber-500/5 shadow-xs">
          <div class="flex items-center justify-between">
            <span class="text-xs font-semibold text-amber-700 dark:text-amber-300">FHIR R4 Gateway</span>
      ...
      <div class="p-6 rounded-2xl border border-border bg-card shadow-xs space-y-4">
        <div class="flex justify-between items-center pb-3 border-b border-border">
          <div>
            ...
            <p class="text-xs text-muted-foreground">Standardized clinical ontologies loaded into Sentinel terminology engine.</p>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div class="p-4 rounded-xl border border-border bg-muted/20 space-y-2">
            <div class="flex justify-between items-center">
              ...
              <span class="px-2 py-0.5 rounded text-[10px] bg-emerald-500/10 text-emerald-600 font-mono font-bold">2026 Release</span>
            </div>
            <p class="text-[11px] text-muted-foreground">International Classification of Diseases 10th Revision Clinical Modification.</p>
            <div class="text-[10px] font-mono text-muted-foreground pt-1">72,000+ Diagnosis Codes</div>
          </div>

          <div class="p-4 rounded-xl border border-border bg-muted/20 space-y-2">
            <div class="flex justify-between items-center">
              <span class="font-bold text-xs text-foreground">SNOMED CT</span>
              <span class="px-2 py-0.5 rounded text-[10px] bg-emerald-500/10 text-emerald-600 font-mono font-bold">US Edition</span>
            </div>
            <p class="text-[11px] text-muted-foreground">Systematized Nomenclature of Medicine Clinical Terms ontology.</p>
          ...
          <div class="p-4 rounded-xl border border-border bg-muted/20 space-y-2">
            <div class="flex justify-between items-center">
              ...
              <span class="px-2 py-0.5 rounded text-[10px] bg-emerald-500/10 text-emerald-600 font-mono font-bold">v2.77</span>
            </div>
            <p class="text-[11px] text-muted-foreground">Logical Observation Identifiers Names and Codes for Laboratory & Radiology.</p>
          ...
          <div class="p-4 rounded-xl border border-border bg-muted/20 space-y-2">
            <div class="flex justify-between items-center">
              ...
              <span class="px-2 py-0.5 rounded text-[10px] bg-emerald-500/10 text-emerald-600 font-mono font-bold">NLM Monthly</span>
            </div>
            <p class="text-[11px] text-muted-foreground">Standardized nomenclature for clinical drugs and active pharmaceutical ingredients.</p>
            <div class="text-[10px] font-mono text-muted-foreground pt-1">RxCUI Mappings Active</div>
          </div>
        </div>
      </div>
    </div>
