...
This guide details the integration, configuration, and execution workflows for generating realistic synthetic patient populations using the **Synthea Patient Generator** and ingesting them into **MedVault**.
...
flowchart TD
    ...
    MapEntities --> Database[(Persist to MedVault DB)]
