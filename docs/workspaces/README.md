...
| [Receptionist Workspace](file:///mnt/workspace/Sentinel-EHR/docs/workspaces/receptionist-workspace-spec.md) | `ROLE_RECEPTIONIST` | Master Patient Index (MPI) probabilistic matching, X12 270/271 real-time eligibility (RTE), multi-resource scheduling, demographic privacy isolation (HIPAA Minimum Necessary). |
