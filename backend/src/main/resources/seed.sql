...
-- ------------------------------------------------------------------------------
INSERT INTO patients (id, patient_code, abha_id, national_id, full_name, date_of_birth, gender, blood_type, phone, email, address, pin_code, emergency_contact, insurance_provider, insurance_policy_number, insurance_group_number, coverage_plan, department, organization_id, medical_alerts, dietary_habits, smoking_status, alcohol_consumption, exercise_routine, food_allergies, past_medical_history, serious_conditions, surgeries_and_procedures, family_medical_history, user_id, created_at) VALUES 
(1, 'PAT-1001', '91-4590-1284-9001', 'AADHAAR-4590-1284', 'Kamran Khan', '2004-04-04', 'Male', 'A+', '+91 80979 05879', 'kamrankhan.sde@gmail.com', '742 Marine Drive, Mumbai, MH', '400001', 'Mahtab Khan (Brother) - +91 98765 98765', 'Star Health Insurance', 'STAR-9874102', 'GRP-55410', 'Premier Comprehensive Care Gold', 'Cardiovascular Medicine', 1, 'Type 2 Diabetes, Severe Penicillin Allergy, Mild Asthma', 'Low Sodium, Diabetic Controlled, Non-Vegetarian', 'NEVER', 'NONE', 'MODERATE', 'Peanuts, Shellfish', 'Type 2 Diabetes Mellitus (2020), Mild Asthmatic Bronchitis (2018)', 'Type 2 Diabetes Mellitus with Mild Retinopathy Risk', 'Laparoscopic Appendectomy (2019)', 'Father: Type 2 Diabetes; Mother: Essential Hypertension', 9, CURRENT_TIMESTAMP),

(2, 'PAT-1002', '91-2180-0983-1002', 'AADHAAR-2180-9831', 'Aarav Patel', '1972-09-28', 'Male', 'A+', '+91 98765 12345', 'aarav.patel@example.com', '1204 CG Road, Ahmedabad, GJ', '380009', 'Priya Patel (Wife) - +91 98765 87654', 'HDFC ERGO Health', 'HDFC-5510923', 'GRP-11092', 'Optima Secure Super Plan', 'Cardiovascular Medicine', 1, 'Essential Hypertension, Hyperlipidemia, Sulfa Allergy', 'Vegetarian, Low Fat, High Fiber', 'FORMER', 'OCCASIONAL', 'SEDENTARY', 'None', 'Essential Hypertension (2016), Hyperlipidemia (2018), Nephrolithiasis (2021)', 'Primary Essential Hypertension, Atherosclerotic Vascular Risk', 'Percutaneous Coronary Intervention with DES (2022)', 'Father: Premature CAD (MI at 52); Paternal Uncle: Stroke', 10, CURRENT_TIMESTAMP),

(3, 'PAT-1003', '91-7810-0449-1003', 'AADHAAR-7810-4491', 'Ananya Sharma', '1996-11-05', 'Female', 'B-', '+91 98765 67890', 'ananya.sharma@example.com', '45 Park Street, Kolkata, WB', '700016', 'Rajesh Sharma (Father) - +91 98765 76543', 'ICICI Lombard', 'ICI-7740192', 'GRP-88102', 'Health Shield Platinum Plan', 'Neurological Sciences', 1, 'Latex Allergy, Migraine with Aura', 'Gluten-Free, Mediterranean, Vegetarian', 'NEVER', 'NONE', 'ACTIVE', 'Latex, Soy', 'Migraine with Aura (2019), Contact Dermatitis (2026)', 'Refractory Episodic Migraine', 'None reported', 'Mother: Thyroiditis; Maternal Grandmother: Rheumatoid Arthritis', 11, CURRENT_TIMESTAMP),

(4, 'PAT-1004', '91-3120-0558-2004', 'AADHAAR-3120-5582', 'Rohan Mehta', '1990-07-22', 'Male', 'AB+', '+91 98765 88990', 'rohan.mehta@example.com', '88 Bandra Reclamation, Mumbai, MH', '400050', 'Neha Mehta (Sister) - +91 98765 11223', 'Care Health Insurance', 'CARE-3341029', 'GRP-99401', 'Care Supreme Gold Protection', 'Neurological Sciences', 1, 'Peanut Allergy, Anaphylactic Risk', 'High Protein, Omnivore', 'NEVER', 'OCCASIONAL', 'ACTIVE', 'Peanuts, Tree Nuts', 'Tension Headache (Resolved), Seasonal Allergic Rhinitis', 'Severe Anaphylactic Peanut Hypersensitivity', 'Knee Arthroscopy (2021)', 'Father: Hyperlipidemia', 12, CURRENT_TIMESTAMP),

(5, 'PAT-1005', '91-8051-6387-5709', 'AADHAAR-8458-4689', 'Kabir Rao', '1983-03-15', 'Male', 'AB+', '+91 91474 44615', 'kabir.rao@sentinel-health.in', 'House No. 123, Block C, Mumbai, MH', '400001', 'Sneha Rao (Sister) - +91 75556 05154', 'Bajaj Allianz', 'POL-500412', 'GRP-1299', 'Health Guard Platinum Plan', 'Emergency & Acute Care', 1, 'Stage 3 Chronic Kidney Disease, GFR 52 mL/min', 'Low Sodium, Low Protein, Renal Friendly', 'CURRENT_LIGHT', 'MODERATE', 'SEDENTARY', 'Lactose', 'Stage 3 Chronic Kidney Disease (2013), Gouty Arthritis (2019)', 'Stage 3A Chronic Kidney Disease', 'None', 'Father: Chronic Kidney Disease; Mother: Type 2 Diabetes', 18, CURRENT_TIMESTAMP),

(6, 'PAT-1006', '91-5521-1782-9119', 'AADHAAR-4089-9332', 'Sneha Rao', '1999-07-16', 'Female', 'A-', '+91 87995 42134', 'sneha.rao@sentinel-health.in', 'House No. 137, Block B, New Delhi, DL', '110001', 'Kabir Rao (Brother) - +91 98805 48003', 'HDFC ERGO Health', 'POL-234096', 'GRP-3594', 'Optima Secure Comprehensive', 'Endocrinology & Diabetes', 1, 'Ibuprofen Life-Threatening Anaphylaxis', 'Vegetarian, Organic', 'NEVER', 'NONE', 'MODERATE', 'NSAIDs, Ibuprofen', 'Bronchial Asthma (2015), Hypothyroidism (2020)', 'Severe NSAID Hypersensitivity & Mild Bronchospasm', 'None', 'Mother: Hashimoto Thyroiditis', 19, CURRENT_TIMESTAMP);
