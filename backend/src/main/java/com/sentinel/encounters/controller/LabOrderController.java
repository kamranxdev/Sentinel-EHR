...
public class LabOrderController {
    ...
    @GetMapping
    @PreAuthorize("hasAnyAuthority('LAB_RESULT_READ', 'ROLE_LAB_TECH', 'ROLE_NURSE', 'ROLE_DOCTOR', 'ROLE_SYS_ADMIN', 'ROLE_ORG_ADMIN')")
    ...
    @PostMapping
    @PreAuthorize("hasAnyAuthority('ROLE_DOCTOR', 'ROLE_SYS_ADMIN', 'ROLE_ORG_ADMIN')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_LAB_TECH', 'ROLE_NURSE', 'ROLE_DOCTOR', 'ROLE_SYS_ADMIN', 'ROLE_ORG_ADMIN')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_LAB_TECH', 'ROLE_SYS_ADMIN', 'ROLE_ORG_ADMIN')")
