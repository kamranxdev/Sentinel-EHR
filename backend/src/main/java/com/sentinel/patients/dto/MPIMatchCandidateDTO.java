...
public class MPIMatchCandidateDTO {
    ...
    private List<String> matchingFields; // e.g. ["Name", "DOB", "SSN_Last4", "Phone"]
    private List<String> conflictingFields; // e.g. ["Address"]

    public MPIMatchCandidateDTO() {}

    public MPIMatchCandidateDTO(Patient patient, double matchScore, String matchClassification, List<String> matchingFields, List<String> conflictingFields) {
