...
public class EncounterResponseDTO {
    ...
    private String careEpisodeCode;
    ...
    private List<EncounterParticipantResponseDTO> participants = new ArrayList<>();
    ...
    public String getCareEpisodeCode() { return careEpisodeCode; }
    public void setCareEpisodeCode(String careEpisodeCode) { this.careEpisodeCode = careEpisodeCode; }
    ...
    public List<EncounterParticipantResponseDTO> getParticipants() { return participants; }
    public void setParticipants(List<EncounterParticipantResponseDTO> participants) { this.participants = participants; }
