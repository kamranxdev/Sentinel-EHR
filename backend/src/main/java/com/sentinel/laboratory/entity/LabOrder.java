...
public class LabOrder {
    ...
    private String testName; // e.g. Complete Blood Count (CBC), Basic Metabolic Panel

    private String loincCode; // LOINC code

    @Column(nullable = false)
    private String category = "LABORATORY";

    @Column(nullable = false)
    private String status = "ORDERED"; // ORDERED, SPECIMEN_COLLECTED, IN_PROCESS, RESULTED, CLINICIAN_REVIEWED, CANCELLED, REJECTED
